...
# Api de info del usuario
from flask import Flask, jsonify
from datetime import datetime

app = Flask(__name__)

@app.route('/api/info-usuario', methods=['GET'])
def info_usuario():
    # Datos fijos para todos los usuarios
    nombre = "Gestor de Inventarios"
    rol = "Gestor de Inventarios"
...
# Bloque que debes modificar así:
if __name__ == "__main__":
